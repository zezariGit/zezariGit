...
const TOSS_PAYMENT_CANCELLATION_CODES = new Set(["USER_CANCEL", "PAY_PROCESS_CANCELED", "PAY_PROCESS_ABORTED"]);

export function isTossPaymentCancellation(code) {
  return TOSS_PAYMENT_CANCELLATION_CODES.has(String(code || "").trim().toUpperCase());
}
