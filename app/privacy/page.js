      ...
      <article className="privacy-shell">
            ...
            <table>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>위도, 경도, 위치 정확도, QR·관리대상 연결정보, 접속 IP와 브라우저 정보의 일방향 해시</td>
                </tr>
                <tr>
                  <td>푸시 알림</td>
        ...
        <section className="privacy-section" id="privacy-location">
          ...
          <p>
            ...
            허용한 뒤 위치정보 수집·이용 및 지정 보호자 제공에 별도로 동의한 경우에만 위도, 경도와
            정확도를 수집합니다. 좌표는 카카오맵·네이버지도 링크 생성, 보호자 푸시 알림 및 안전한
            인계 확인에 사용됩니다.
          </p>
          <p>
            좌표와 정확도는 AES-256-GCM으로 암호화하여 저장하고, 접속 IP와 브라우저 식별정보는 원문이
            아닌 일방향 해시로 기록합니다. 원본 위치정보는 수집 시점부터 24시간 동안 안전한 인계와
            사고 대응 목적으로 보관한 뒤 좌표, 암호문과 지도 URL을 자동 파기합니다. 수집·이용·제공·파기
            사실 확인자료와 접근기록은 관련 법령과 내부 관리지침에서 정한 기간 동안 별도로 보관합니다.
          </p>
        </section>
