...
import { getGuardianPhotoData } from "../../../../../lib/db";
...
export async function GET() {
  ...
  const photo = await getGuardianPhotoData(session);
  ...
  return new NextResponse(parsed.buffer, {
    ...
    headers: {
      ...
      "Content-Disposition": `inline; filename="${encodeURIComponent(photo.photo_name || "guardian-photo")}"`,
