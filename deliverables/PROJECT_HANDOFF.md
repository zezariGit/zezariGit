...
Application baseline commit: `36c8342` (`main`, 로컬 구현 완료, GitHub/Vercel 운영 반영 대기)
...
| 최근 애플리케이션 기능 기준 | local commit `36c8342`; 운영 기준 commit `957553b`, deployment `dpl_E19dHgcypFn11T8TGpeSo8YnA951` |
